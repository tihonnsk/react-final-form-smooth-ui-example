...
const App = () => (
  <Row>
    <Col />
    <Col xs={8}>
      <Typography variant="h1">🏁 React Final Form</Typography>
      <Typography variant="h2">🍭 Smooth-UI Example</Typography>
      <p>
        ...
        higher-order component that adapts the 🍭 Smooth-UI form components to
        be compatible with 🏁 React Final Form.
      </p>
      <Form
        onSubmit={onSubmit}
